...
// WithPayload adds the payload to the add tier created response
func (o *AddTierCreated) WithPayload(payload *models.Tier) *AddTierCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the add tier created response
func (o *AddTierCreated) SetPayload(payload *models.Tier) {
	o.Payload = payload
}
